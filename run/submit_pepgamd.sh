...
&cntrl
  ...
  ntr=0,
  ig=-1,
  ntpr=5000, ntwx=50000, ntwr=5000, ntwe=5000,
...
CUDA_VISIBLE_DEVICES=$cuda_device pmemd.cuda -O -i ligamd_md.in -o ligamd_md.out -p com_solv.prmtop -c ligamd_pre.rst -r ligamd_md.rst -x ligamd_md.dcd
